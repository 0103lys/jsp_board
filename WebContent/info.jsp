...
<body>
    ...
    <form action="info_ok.jsp" name="regform" id="regform" method="post" onsubmit="return sendit()">
        ...
        <%
        	if(compare_hobby("드라이브", member.getHobby())){
        		out.print("checked");
        	}
        %>
        ></label> 
        ...
        <%
        	if(compare_hobby("영화감상", member.getHobby())){
    			out.print("checked");
    		}
        %>
        ></label> 
        ...
        <%
        	if(compare_hobby("쇼핑", member.getHobby())){
    			out.print("checked");
    		}
        %>
        ></label> 
        ...
        <%
        	if(compare_hobby("요가", member.getHobby())){
    			out.print("checked");
    		}
        %>
        ></label> 
        ...
        <%
        	if(compare_hobby("헬스", member.getHobby())){
    			out.print("checked");
    		}
        %>
        ></label></p>
